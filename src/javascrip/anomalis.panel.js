...
const ViagemDisplayFive = document.querySelector(".display-5")
const CardViagemOpenFive = document.querySelector(".viagem-card-open-5")
...
CardViagemOpenFive.addEventListener("click", ()=>{
    CardViagemOpenFive.classList.toggle("arrow-animation-2")
    ViagemDisplayFive.classList.toggle("display-active-2")
